...
export function Home() {
    ...
    const totalEntradas = lista.reduce((sum, item) => sum + item.entrada, 0);
    const totalSaidas = lista.reduce((sum, item) => sum + item.saida, 0);
                ...
                <Container>
                    <div className="align">
                        <div className="content">
                            <h1 className="font"><strong>Total Entradas: {totalEntradas}</strong></h1>
